...
function StatsBand({
  ...
  return (
    ...
    >
      ...
      >
        {stats.map((s, i) => {
          // Border-left: mobile (2-col) needs divider on i=1,3 ; desktop (4-col) on i=1,2,3
          const mobileHasBorder = i % 2 === 1;        // i=1,3
          const desktopHasBorder = i !== 0;           // i=1,2,3
          return (
          <div
            key={s.l}
            className={`${mobileHasBorder ? "pl-5 border-l border-[color:var(--gc-hairline)]" : ""} ${
              desktopHasBorder ? "md:pl-8 md:border-l md:border-[color:var(--gc-hairline)]" : "md:border-none md:pl-0"
            }`}
          >
            <div
