...
export const metadata: Metadata = {
  ...
  title: {
    ...
    // suffix에서 "한능검" 제거 — 공무원/자격증 페이지의 page-level title과 충돌 회피.
    // 한능검 페이지는 page-level title에 이미 "한능검" 포함되어 사이트와이드 시그널 손실 없음.
    template: "%s | 기출노트",
  },
  description:
  ...
  keywords: [
    ...
    "2급",
    "심화",
    // 공무원·자격증 시그널 — Tier S "공무원 기출노트" + Tier A·B 패턴 D 키워드 (낮은 dilution risk)
    "공무원 기출노트",
    "공무원 기출문제",
    "공무원 단원별 정리",
    "공무원 한국사",       // Tier B vol 1,160
    "공무원 한국사 정리",
    "9급 공무원 한국사",   // Tier B vol 390
    "9급 공무원 기출",
    "행정학 기출",          // Tier A vol 340
  ...
  return (
    <html lang="ko">
      <head>
        ...
        {/* AdFit (카카오 애드핏) — 2026-06-27 비활성 (쿠팡 광고 우선). SDK 로드 제거. */}
