...
export const metadata: Metadata = {
  title: "한능검 기출문제 무료 — 1,900문항 회차별·시대별 정리 | 기출노트",
  description:
    "한능검 기출문제 1,900+ 문항을 무료로 풀어보세요. 제40~77회 회차별 풀이, 시대별·유형별 맞춤 학습, 키워드 3,800개 정리. AI 해설 + 최태성 영상강의 + 오답노트 자동 수집. 1급(80점)·2급(70점)·3급(60점) 평생 무료 — 기출노트.",
  keywords: [
    "한능검 기출문제", "한능검 무료", "한능검 기출",
    "한능검 시대별 정리", "한능검 단원별 기출", "한능검 회차별",
    "한국사능력검정시험 기출", "한능검 학습", "한능검 문제풀기",
    "기출노트", "기출노트 한능검", "한능검 기출노트",
  ],
  alternates: { canonical: "/study" },
  openGraph: {
    title: "한능검 기출문제 무료 — 1,900문항 회차별·시대별",
    description: "한능검 기출문제 1,900+ 무료 풀이. 회차별·시대별·키워드별 맞춤 학습 + AI 해설 + 영상강의 + 오답노트 자동.",
    url: "/study",
    type: "website",
    siteName: "기출노트 한능검",
  },
