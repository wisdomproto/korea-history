  ...
  return (
    ...
    >
      ...
      >
        ...
        <p>
          <b style={{ color: T.ink }}>공무원 한국사·9급 한국사도 한능검으로 무료 학습</b>합니다.
          9급 국가직·지방직·서울시·7급 공무원, 경찰·소방·계리직, 군무원 등 한국사 시험은{" "}
          <b style={{ color: T.ink }}>한능검 인증서로 대체</b>되며 (2027년부터 9급까지 전면 통합), 보건의료직·회계사·관세사 등 자격증 시험에서도 한능검이 가산점·필수 인증으로 활용됩니다.
          기출노트의 한능검 콘텐츠 — 1,900+ 기출문제, 87개 시대별 요약노트, 자동 오답노트,
          맞춤 학습 세션 — 은 회원가입 없이 무료로 사용할 수 있으며, 공무원 응시생도 별도 가입 없이
          바로 시작 가능합니다.
        </p>
      </div>
    </section>
